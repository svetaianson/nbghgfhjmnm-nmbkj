    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          <h2 className="mb-2 text-3xl sm:text-4xl font-bold text-white lg:text-5xl">How It Works</h2>
          <div className="mx-auto mb-4 h-1 w-48 sm:w-64 bg-gradient-to-r from-[#6D1D7D] via-[#5F0BE8] to-[#6D1D7D]" />
          <p className="mb-32 sm:mb-36 lg:mb-40 text-base sm:text-lg text-gray-300">
            Simple, fast and powerful chart analysis in three steps
          </p>
        </div>
