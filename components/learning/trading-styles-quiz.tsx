...
const questions = [
  {
    question: "Which trading style holds positions for only seconds to minutes?",
    options: ["Swing Trading", "Position Trading", "Scalping", "Day Trading"],
    correct: 2,
  },
  {
    question: "Which trading style is best for someone with a full-time job?",
    options: ["Scalping", "Swing Trading", "Day Trading", "High-frequency trading"],
    correct: 1,
  },
  {
    question: "What is the main characteristic of day trading?",
    options: [
      "Holding positions for weeks",
      "Never holding trades overnight",
      "Only trading once per month",
      ...
      <main className="relative z-10 px-4 sm:px-6 lg:px-16 py-8 lg:py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="border-2 border-[#5F0BE8]/30 bg-[#1a0f2e]/40 backdrop-blur-xl p-8 rounded-2xl">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-white mb-2">Trading Styles Quiz</h1>
