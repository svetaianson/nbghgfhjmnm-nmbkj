...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Declining prices and investor pessimism" },
      { label: "B", text: "Rising prices and increased investor confidence" },
      { label: "C", text: "Sideways price movement with no clear direction" },
    ],
    correctAnswer: "B",
  },
  {
    id: 2,
    question: "What is a common trading strategy in a bear market?",
    options: [
      { label: "A", text: "Buy the dips" },
      { label: "B", text: "Sell the rallies" },
      { label: "C", text: "Hold and never sell" },
    ],
    correctAnswer: "B",
  },
  {
    id: 3,
    question: "In a bull market, what pattern typically appears in price action?",
    options: [
      { label: "A", text: "Lower highs and lower lows" },
      { label: "B", text: "Higher lows with each pullback finding support above previous lows" },
      { label: "C", text: "Random unpredictable movements" },
    ],
    correctAnswer: "B",
  },
]

export function BullsAndBearsQuiz() {
