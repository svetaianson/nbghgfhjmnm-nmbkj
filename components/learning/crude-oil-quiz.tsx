...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "They celebrate too much" },
      { label: "B", text: "Higher import costs hurt economic growth" },
      { label: "C", text: "They start exporting oil" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "The Cable" },
      { label: "B", text: "The Loonie" },
      { label: "C", text: "The Fiber" },
    ],
    correctAnswer: "B",
  },
]

export function CrudeOilQuiz() {
