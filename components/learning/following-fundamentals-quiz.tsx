...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "It weakens" },
      { label: "B", text: "It strengthens" },
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "Total value of goods and services produced" },
      { label: "B", text: "Total number of employees" },
      { label: "C", text: "Total currency in circulation" },
    ],
    correctAnswer: "A",
  },
  {
    ...
    options: [
      { label: "A", text: "Plans to lower interest rates" },
      { label: "B", text: "Plans to raise interest rates" },
      { label: "C", text: "No change in policy" },
    ],
    correctAnswer: "B",
  },
]

export function FollowingFundamentalsQuiz() {
