...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Copying trades from successful traders automatically" },
      { label: "B", text: "Trading only on social media platforms" },
      { label: "C", text: "Trading with friends only" },
    ],
    correctAnswer: "A",
  },
  {
    ...
    options: [
      { label: "A", text: "Learning from experienced traders while earning" },
      { label: "B", text: "Guaranteed profits with no risk" },
      { label: "C", text: "No need to understand trading at all" },
    ],
    correctAnswer: "A",
  },
  {
    ...
    options: [
      { label: "A", text: "Only their total profit" },
      { label: "B", text: "Their track record, risk management, and consistency" },
      { label: "C", text: "How many followers they have" },
    ],
    correctAnswer: "B",
  },
]

export function SocialTradingQuiz() {
