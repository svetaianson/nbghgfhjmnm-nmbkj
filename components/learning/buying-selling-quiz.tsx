...
const questions = [
  {
    question: "When you buy EUR/USD, what are you actually doing?",
    options: ["Buying USD and selling EUR", "Buying EUR and selling USD", "Only buying EUR", "Only selling USD"],
    correct: 1,
  },
  {
    question: "What type of order executes your trade immediately at the current market price?",
    options: ["Limit Order", "Stop Order", "Market Order", "Pending Order"],
    correct: 2,
  },
  {
    question: "If you sell GBP/USD, you profit when:",
    options: [
      "GBP strengthens against USD",
      "GBP weakens against USD",
      "Both currencies rise equally",
      "Neither currency moves",
    ],
    correct: 1,
  },
]

interface BuyingSellingQuizProps {
  onBack: () => void
}

export function BuyingSellingQuiz({ onBack }: BuyingSellingQuizProps) {
      ...
      <main className="relative z-10 px-4 sm:px-6 lg:px-16 py-8 lg:py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="border-2 border-[#5F0BE8]/30 bg-[#1a0f2e]/40 backdrop-blur-xl p-8 rounded-2xl">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-white mb-2">Buying and Selling Quiz</h1>
