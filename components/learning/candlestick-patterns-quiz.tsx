...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "A bearish reversal" },
      { label: "B", text: "A bullish reversal, especially at support levels" },
      { label: "C", text: "Market indecision with no clear direction" },
    ],
    correctAnswer: "B",
  },
  {
    id: 2,
    question: "What characterizes a Doji candlestick?",
    options: [
      { label: "A", text: "A very long body with no wicks" },
      { label: "B", text: "Open and close prices are virtually the same, creating little to no body" },
      { label: "C", text: "A small body with one long wick" },
    ],
    correctAnswer: "B",
  },
  {
    id: 3,
    question: "When are candlestick patterns most reliable?",
    options: [
      { label: "A", text: "At random locations on the chart" },
      { label: "B", text: "When they appear at key support/resistance levels and confluence zones" },
      { label: "C", text: "Only during market opening hours" },
    ],
    correctAnswer: "B",
  },
]

export function CandlestickPatternsQuiz() {
