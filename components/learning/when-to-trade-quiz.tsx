...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "24 hours a day, 5 days a week" },
      { label: "B", text: "9 AM to 5 PM only" },
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "Asian session" },
      { label: "B", text: "London session" },
      { label: "C", text: "New York session" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "When Asian and European markets are open" },
      { label: "B", text: "When European and US markets overlap" },
      { label: "C", text: "During weekends" },
    ],
    correctAnswer: "B",
  },
]

export function WhenToTradeQuiz() {
