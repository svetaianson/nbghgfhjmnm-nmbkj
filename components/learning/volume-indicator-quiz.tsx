...
interface VolumeIndicatorQuizProps {
  onBack: () => void
}

export function VolumeIndicatorQuiz({ onBack }: VolumeIndicatorQuizProps) {
      ...
      <main className="relative z-10 px-4 sm:px-6 lg:px-16 py-8 lg:py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="border-2 border-[#5F0BE8]/30 bg-[#1a0f2e]/40 backdrop-blur-xl p-8 rounded-2xl">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-white mb-2">Volume Indicator Quiz</h1>
