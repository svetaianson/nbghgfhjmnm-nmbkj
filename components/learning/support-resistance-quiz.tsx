...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "A price level where selling pressure overcomes buying interest" },
      { label: "B", text: "A price level where buying interest prevents the price from falling further" },
      { label: "C", text: "A random price point with no significance" },
    ],
    correctAnswer: "B",
  },
  {
    id: 2,
    question: "What often happens after a resistance level is broken?",
    options: [
      { label: "A", text: "It becomes a new support level" },
      { label: "B", text: "It disappears completely" },
  ...
  {
    id: 3,
    question: "How should support and resistance levels be viewed?",
    options: [
      { label: "A", text: "As exact price points that must be touched precisely" },
      { label: "B", text: "As zones or areas where buying or selling pressure emerges" },
      { label: "C", text: "As irrelevant to trading decisions" },
    ],
    correctAnswer: "B",
  },
]

export function SupportResistanceQuiz() {
