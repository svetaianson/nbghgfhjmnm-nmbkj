...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Lower highs and lower lows" },
      { label: "B", text: "Higher highs and higher lows" },
      { label: "C", text: "Horizontal price movement" },
    ],
    correctAnswer: "B",
  },
  {
    id: 2,
    question: "What is the best strategy when trading in a downtrend?",
    options: [
      { label: "A", text: "Buy at every opportunity" },
      { label: "B", text: "Look for selling opportunities on rallies" },
      { label: "C", text: "Ignore the trend" },
    ],
    correctAnswer: "B",
  },
  {
    id: 3,
    question: "What does the trading principle 'The trend is your friend' mean?",
    options: [
      { label: "A", text: "Always trade against the trend for better profits" },
      { label: "B", text: "Trading in the direction of the trend increases probability of success" },
      { label: "C", text: "Trends don't matter in trading" },
    ],
    correctAnswer: "B",
  },
]

export function UnderstandingTrendsQuiz() {
