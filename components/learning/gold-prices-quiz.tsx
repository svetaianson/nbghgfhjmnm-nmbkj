...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Gold prices increase" },
      { label: "B", text: "Gold prices decrease" },
      { label: "C", text: "No effect on gold prices" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "It's easy to trade" },
      { label: "B", text: "Investors seek it during times of uncertainty" },
      { label: "C", text: "It always increases in value" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "EUR and GBP" },
      { label: "B", text: "USD and JPY" },
      { label: "C", text: "AUD and CAD" },
    ],
    correctAnswer: "C",
  },
]

export function GoldPricesQuiz() {
