...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "$200 billion" },
      { label: "B", text: "$7 trillion" },
      { label: "C", text: "$500 million" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "9 AM - 5 PM weekdays" },
      { label: "B", text: "24 hours a day, 5 days a week" },
      { label: "C", text: "Only during business hours" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "Stock market" },
      { label: "B", text: "Forex market" },
      { label: "C", text: "Both offer the same" },
    ],
    correctAnswer: "B",
  },
]
