...
const questions: Question[] = [
  {
    id: 1,
    question: "How much is normal to make in interest per day in Forex?",
    options: [
      { label: "A", text: "1-3%" },
      { label: "B", text: "5-10%" },
      { label: "C", text: "30-50%" },
  ...
  },
  {
    ...
    options: [
      { label: "A", text: "Start with large investments" },
      { label: "B", text: "Start small and learn gradually" },
      { label: "C", text: "Invest all savings immediately" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "Making quick profits" },
      { label: "B", text: "Consistent strategy and risk management" },
      { label: "C", text: "Following market rumors" },
    ],
    correctAnswer: "B",
  },
]

export function HowMuchQuiz() {
