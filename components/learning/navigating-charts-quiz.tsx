...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Line charts" },
      { label: "B", text: "Candlestick charts" },
      { label: "C", text: "Pie charts" },
    ],
    correctAnswer: "B",
  },
  {
    id: 2,
    question: "What does OHLC stand for in trading charts?",
    options: [
      { label: "A", text: "Open, High, Low, Close" },
      { label: "B", text: "Over, High, Limited, Closed" },
      { label: "C", text: "Optimal, Heavy, Light, Current" },
    ],
    correctAnswer: "A",
  },
  {
    ...
    options: [
      { label: "A", text: "Monthly charts" },
      { label: "B", text: "1-15 minute charts" },
      { label: "C", text: "Yearly charts" },
    ],
    correctAnswer: "B",
  },
]

export function NavigatingChartsQuiz() {
