...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "A type of currency" },
      { label: "B", text: "The smallest price move in a currency pair" },
      { label: "C", text: "A trading platform" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "Trading for a long time" },
      { label: "B", text: "Buying a currency pair" },
      { label: "C", text: "Selling a currency pair" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "To increase profits" },
      { label: "B", text: "To limit potential losses" },
      { label: "C", text: "To close winning trades" },
    ],
    correctAnswer: "B",
  },
]
